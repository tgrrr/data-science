...
cat("rowMeans: \n")
rowMeans(private_consumption[,2:11], na.rm=T)

private_consumption

# UP to here!
private_consumption_with_row_mean <- private_consumption <- rowMeans(private_consumption, na.rm=T)
private_consumption_with_row_mean

private_consumption

# Get rowMeans while ignoring characters
rowMeans(private_consumption[sapply(private_consumption, is.numeric)])

# doesn't work:
# private_consumption_numeric[2:11] <- as.numeric(private_consumption[2:11])

#broken
cat("recode: \n")

private_consumption[is.na(private_consumption)] <-
