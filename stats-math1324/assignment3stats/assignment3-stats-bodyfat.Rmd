...
packagesList <- c("readr", "base", "readxl", "dplyr", "mosaic", "gridExtra", "latticeExtra", "epitools", "qqplotr", "car", "ggplot2") %>% as.list()
...
body$Sex <- factor(body$Sex, levels = c(1,0), labels = c("Male","Female")) #Assign correct labels Sex: “1” for male and “0” for female
...
Null hypothesis, H0: μ1 -μ2= 0.0
Alternative hypothesis, Ha: μ1 -μ2≠ 0.0 or μ1 -μ2> 0.0 or μ1 -μ2< 0.0
...
1   0 0.0 12.775  18.75 25.35 45.1 19.42283 8.425499  92       0
2   1 4.6 13.100  19.05 24.05 38.2 18.66000 7.348052 160       0

```{r}
qqPlot(body, dist="norm") #Check normality if required # gives a weird answer
```
...
cis<-data.frame(Group = c("Male","Female"),
                ...
                UB = c(20.17, 21.73))
# TODO:
p <- ggplot(body, aes(Sex, y = BFP_Brozek)) + 
  geom_dotplot(binaxis = "y", stackdir = "center",alpha = 0.3) +
  stat_function(data = cis,mapping = aes(x = Group, y = Means),
...
Is this all we have to do for question 2?
_______________________________________
