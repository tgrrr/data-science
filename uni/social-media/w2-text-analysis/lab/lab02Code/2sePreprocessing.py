...
# list of posts
postsList = []
# list of labels, note the indices of this and postsList should match.
labelsList = []
...
with open(inputPostFile, 'r') as f:
    for sLine in f:
        ...
        # split the string of tags into a list of tags then add to labelsList
        labelsList.append(doc['Tags'].split(' '))
    ...
    X = vectorizer.fit_transform(postsList)
    ...
    y = mlb.fit_transform(labelsList)
