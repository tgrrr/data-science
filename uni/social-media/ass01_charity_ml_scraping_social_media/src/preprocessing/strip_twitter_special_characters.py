...
def strip_links(text):
    ...
    @param    text: Text including links `text`.
    @type:    string

    @return:  Text minus links.
    @type:    string
...
def strip_all_entities(text):
    """
    @summary: Strip any words starting with # or @.
    @author:  Phil S phil@tgrrr.com

    @param    text: `text` including @mentions and #hashtags.
    @type:    string

    @return:  text minus @mentions and #hashtags.
    @rtype:   string
    """
    entity_prefixes = ['@','#']
...
def remove_newline(text):
    """
    @summary: Remove newline `\n`.
    @author:  Phil S phil@tgrrr.com

    @param    text: `text` including escaped newline `\n`.
    @type:    string

    @return:  Text minus newline.
    @rtype:   string
    """
