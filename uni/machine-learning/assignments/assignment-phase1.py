...
if "assignments" not in __working_directory__:
    __data_directory__ = r"assignments/raw-data/"
elif "raw-data" not in __working_directory__:
    __data_directory__ = r"raw-data/"
else:
    __data_directory__ = r""

print(os.path.join(os.getcwd(), __data_directory__))
os.chdir(os.path.join(os.getcwd(), __data_directory__))
#%%
