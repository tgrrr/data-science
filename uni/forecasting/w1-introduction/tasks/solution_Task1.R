...
earthquakes = read.csv("~/Documents/MATH1307_Forecasting/Tasks/Task 1/earthquakes.csv")
...
plot(earthquakes, ylab="Number of earthquakes", xlab = "Year", main = "Number of earthquakes per year 
...
par(mfrow=c(1,1))
plot(flow, ylab="Mean monthly flow", xlab = "Year", main = "Nmean monthly flow series recorded 
     for Piper’s Hole River")
