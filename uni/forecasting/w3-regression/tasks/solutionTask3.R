...
model4 = ardlDlm(formula = Warming ~ CO2 , data = globalWarming, p = 1 , q = 1 )
summary(model4)
checkresiduals(model4$model)
...
lines(ts(as.vector(warming), start = 1959),col="black",type="o")
legend("topleft",lty=1, pch = 1, text.width = 11, col=c( "blue", "red", "green", "purple", "black"), c("Dlm", "Polynomial", "Koyck", 
                                                                                                       "ARDL", "Warming"))
