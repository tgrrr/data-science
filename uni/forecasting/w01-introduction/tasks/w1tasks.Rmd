...
source('/Users/phil/code/data-science/uni/time-series/common/utils.r')
```
...
earthquakes = read_csv(
  "/Users/phil/code/data-science/datasets/forecasting/earthquakes.csv", 
  col_names = TRUE, 
)
# class(earthquakes)
# earthquakes %>% head()
...
flow = read_csv(
  "/Users/phil/code/data-science/datasets/forecasting/flow.csv", 
  col_names = TRUE, 
)
flow %>% head()
flow %>% tail()
