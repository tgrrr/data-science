...
source('/Users/phil/code/data-science/uni/common/utils.R')
...
global_warming = read_csv(
  "/Users/phil/code/data-science/datasets/forecasting/global_warming.csv", 
  col_names = TRUE, 
)
...
inflation = read_csv(
  "/Users/phil/code/data-science/datasets/forecasting/inflation.csv", 
  col_names = TRUE, 
)
# class(inflation)
# inflation %>% head()
