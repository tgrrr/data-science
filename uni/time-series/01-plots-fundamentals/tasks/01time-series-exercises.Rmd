...
```{r}
# TODO: change to data and data.ts for reusability
data <-
...
### TODO: check #converting the generated data to a time series object
```{r}
...
TODO: wk1q2. Plot with random values
- [ ] Display the time series plot without converting the generated data to a time series object 
...
```{r}
# TODO: WRONG: learn this. This breaks it, because data is wrong
rownames(data) <- seq(from = 1995, to = 2016)
colnames(data) <-
  c("jan",
    "feb",
