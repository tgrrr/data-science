...
# ## Specify a set of SARIMA models to the whole series. For the models in the set,
# ## Find parameter estimates.


# ## Do the residual analysis.
# ## Choose the best models and find the next 10 forecasts over this model.
# ## Divide the data into two series.
# ## For the first part, specify a set of SARIMA models. For the models in the set,
# ## Find parameter estimates.
# ## Do the residual analysis.
# ## Choose the best models and find the next 10 forecasts over this model.
# ## Compare these forecasts with the true observations.
# ## For the second part, specify a set of SARIMA models. For the models in the set,
# ## Find parameter estimates.
# ## Do the residual analysis.
# ## Choose the best models and find the next 10 forecasts over this model.
# ## Compare these forecasts with the forecasts of the model that you fit the whole series.
...
#--- Task 1 ---
# Load the monthly commercial landings dataset of US-NMFS from the file “NMFS_Landings.csvPreview the document” into the workspace of R.  Do the following tasks over the landings series;



NMFS_Landings <- read.csv("~/code/data-science/uni/time-series/raw-data/NMFS_Landings.csv")
class(NMFS_Landings)
head(NMFS_Landings)
...
# ??? did he get a model of 1,4 because it's a difference of 1?
...
residual.analysis(model = m5_214.landing)
