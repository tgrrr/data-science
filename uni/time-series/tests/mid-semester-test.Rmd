...
startYear = 1919 # TODO: get start year
# endYear = 0 # TODO: get start year
default_ylab = ''
# default_subtitle = ''
default_xlab = 'Year'
```
...
```{r}
data %>% head(n = 5) # TODO: check for header, set startYear
data %>% tail(n = 5) # TODO: set endYear
```
...
```
TODO: There is a strong positive auto-correlation of the data for concurrent years
...
Slope: β̂<sub>1</sub>= TODO:
Intercept: β̂̂<sub>0</sb>0= TODO:
...
lambda = 1 # The mid point of the interval TODO:
...
```{r}
plot(BC.data.ts,type='o',ylab='TODO', main='Box-Cox TODO ')
...
par(mfrow=c(1,1))
plot(diff.BC.data.ts,type='o',ylab='TODO')
...
#### BIC table
```{r}
# TODO: (Hint: use "  nar=10, nma=10, ar.method='ols'   " options while displaying BIC table).
nar <- 10
nma <- 10
par(mfrow=c(1,1))
res2 = 
