...
NOTE: [utilities file is located on Github](https://github.com/tgrrr/data-science/tree/master/uni/time-series/utils)
...
FIXME: [Download BitCoin CSV data](`r sprintf('data:text/csv;base64,%s', encoded)`)
...
# FIXME: working on
# exp(diffinv(forc@forecast[["seriesFor"]], differences = 2, xi = log(data.ts)[length(data.ts)]))
