...
## TODOLATER: INCLUDE? Compare to previous year
```{r}
# doTimeSeriesPlot(
...
#   col = colourPallete[1])
```
TODOLATER: where's this? Do I need it?
```{r}
...
doTimeSeriesPlot <- 
  function(
    ...
    plot(
      ...
      # x = zlag(ts_data),
      type = 'o',
      ylab = 'TODOLATER: How much humans suck (annually)',
      xlab = 'year',
      col = colourPallete[9],
      pch = 19
    )
...
- TODOLATER: Does it look “random?” - Probably not, tbh
...
## TODOLATER: Should we normalise the data?
```{r}
# TODOLATER: Should we normalise the data?
